...
## Get latest data
cp /project2/cobey/covid-civis/raw_data/case_data_public/idph_public_covid_region_UIUC_removed.csv ../data/idph_public_restore_region.csv 
cp /project2/cobey/covid-civis/raw_data/case_data_public/idph_public_covid_region.csv ../data/idph_public_covid_region.csv
